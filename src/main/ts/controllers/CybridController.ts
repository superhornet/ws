...
router.post("/cybrid/account", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/account", data.session);
...
router.get("/cybrid/account/:account_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/account/${accountGuid}`, session);
...
router.get("/cybrid/accounts", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/accounts", session);
...
router.get("/cybrid/assets", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/assets", session);
...
router.post("/cybrid/bank", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/bank", data.session);
...
router.get("/cybrid/bank/:bank_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/bank/${bankGuid}`, session);
...
router.get("/cybrid/banks", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/banks", session);
...
router.patch("/cybrid/bank/:bank_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`PATCH /api/cybrid/bank/${bankGuid}`, data.session);
...
router.post("/cybrid/counterparty", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/counterparty", data.session);
...
router.get("/cybrid/counterparty/:counterparty_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/counterparty/${counterpartyGuid}`, session);
...
router.get("/cybrid/counterparties", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/counterparties", session);
...
router.post("/cybrid/customer", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/customer", data.session);
...
router.get("/cybrid/customer/:customer_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/customer/${customerGuid}`, session);
...
router.get("/cybrid/customers", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/customers", session);
...
router.patch("/cybrid/customer/:customer_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`PATCH /api/cybrid/customer/${customerGuid}`, data.session);
...
router.post("/cybrid/deposit-address", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/deposit-address", data.session);
...
router.get("/cybrid/deposit-address/:deposit_address_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/deposit-address/${depositAddressGuid}`, session);
...
router.get("/cybrid/deposit-addresses", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/deposit-addresses", session);
...
router.post("/cybrid/deposit-bank-account", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/deposit-bank-account", data.session);
...
router.get("/cybrid/deposit-bank-account/:deposit_bank_account_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/deposit-bank-account/${depositBankAccountGuid}`, session);
        JSONResponse.goodToGo(req, res, "OK", account as unknown as JSON);
    } catch (error) {
        processError(req, res, error as HTMLStatusError);
    }
...
router.get("/cybrid/deposit-bank-accounts", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/deposit-bank-accounts", session);
        JSONResponse.goodToGo(req, res, "OK", accounts as unknown as JSON);
    } catch (error) {
        processError(req, res, error as HTMLStatusError);
    }
...
router.post("/cybrid/execution", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/execution", data.session);
...
router.get("/cybrid/execution/:execution_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/execution/${executionGuid}`, session);
...
router.get("/cybrid/executions", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/executions", session);
...
router.post("/cybrid/external-bank-account", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/external-bank-account", data.session);
...
router.get("/cybrid/external-bank-account/:external_bank_account_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/external-bank-account/${externalBankAccountGuid}`, session);
        JSONResponse.goodToGo(req, res, "OK", account as unknown as JSON);
    } catch (error) {
        processError(req, res, error as HTMLStatusError);
    }
...
router.get("/cybrid/external-bank-accounts", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/external-bank-accounts", session);
        JSONResponse.goodToGo(req, res, "OK", accounts as unknown as JSON);
    } catch (error) {
        processError(req, res, error as HTMLStatusError);
    }
...
router.patch("/cybrid/external-bank-account/:external_bank_account_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`PATCH /api/cybrid/external-bank-account/${externalBankAccountGuid}`, data.session);
...
router.delete("/cybrid/external-bank-account/:external_bank_account_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`DELETE /api/cybrid/external-bank-account/${externalBankAccountGuid}`, session);
...
router.post("/cybrid/external-wallet", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/external-wallet", data.session);
...
router.get("/cybrid/external-wallet/:external_wallet_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/external-wallet/${externalWalletGuid}`, session);
...
router.get("/cybrid/external-wallets", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/external-wallets", session);
...
router.delete("/cybrid/external-wallet/:external_wallet_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`DELETE /api/cybrid/external-wallet/${externalWalletGuid}`, session);
...
router.post("/cybrid/fiat-transfer", async (req, res) => {
    try {
        ...
        await withIdempotency(req, res, data.session, "/cybrid/fiat-transfer", async () => {
            ...
            await Audit.create("POST /api/cybrid/fiat-transfer", data.session);
...
router.post("/cybrid/file", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/file", data.session);
...
router.get("/cybrid/file/:file_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/file/${fileGuid}`, session);
...
router.get("/cybrid/files", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/files", session);
...
router.post("/cybrid/identity-verification", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/identity-verification", data.session);
...
router.get("/cybrid/identity-verification/:verification_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/identity-verification/${verificationGuid}`, session);
...
router.get("/cybrid/identity-verifications", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/identity-verifications", session);
...
router.post("/cybrid/invoice", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/invoice", data.session);
...
router.get("/cybrid/invoice/:invoice_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/invoice/${invoiceGuid}`, session);
...
router.get("/cybrid/invoices", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/invoices", session);
...
router.delete("/cybrid/invoice/:invoice_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`DELETE /api/cybrid/invoice/${invoiceGuid}`, session);
...
router.post("/cybrid/payment-instruction", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/payment-instruction", data.session);
...
router.get("/cybrid/payment-instruction/:payment_instruction_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/payment-instruction/${paymentInstructionGuid}`, session);
...
router.get("/cybrid/payment-instructions", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/payment-instructions", session);
...
router.post("/cybrid/persona-session", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/persona-session", data.session);
...
router.post("/cybrid/plan", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/plan", data.session);
...
router.get("/cybrid/plan/:plan_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/plan/${planGuid}`, session);
...
router.get("/cybrid/plans", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/plans", session);
...
router.get("/cybrid/prices", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/prices", session);
...
router.post("/cybrid/quote", async (req, res) => {
    try {
        ...
        await withIdempotency(req, res, data.session, "/cybrid/quote", async () => {
            ...
            await Audit.create("POST /api/cybrid/quote", data.session);
...
router.get("/cybrid/quote/:quote_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/quote/${quoteGuid}`, session);
...
router.get("/cybrid/quotes", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/quotes", session);
...
router.get("/cybrid/symbols", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/symbols", session);
...
router.post("/cybrid/trade", async (req, res) => {
    try {
        ...
        await withIdempotency(req, res, data.session, "/cybrid/trade", async () => {
            ...
            await Audit.create("POST /api/cybrid/trade", data.session);
...
router.get("/cybrid/trade/:trade_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/trade/${tradeGuid}`, session);
...
router.get("/cybrid/trades", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/trades", session);
...
router.post("/cybrid/transfer", async (req, res) => {
    try {
        ...
        await withIdempotency(req, res, data.session, "/cybrid/transfer", async () => {
            ...
            await Audit.create("POST /api/cybrid/transfer", data.session);
...
router.get("/cybrid/transfer/:transfer_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/transfer/${transferGuid}`, session);
...
router.get("/cybrid/transfers", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/transfers", session);
...
router.patch("/cybrid/transfer/:transfer_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`PATCH /api/cybrid/transfer/${transferGuid}`, data.session);
...
router.post("/cybrid/workflow", async (req, res) => {
    try {
        ...
        await Audit.create("POST /api/cybrid/workflow", data.session);
...
router.get("/cybrid/workflow/:workflow_guid", async (req, res) => {
    try {
        ...
        await Audit.create(`GET /api/cybrid/workflow/${workflowGuid}`, session);
...
router.get("/cybrid/workflows", async (req, res) => {
    try {
        ...
        await Audit.create("GET /api/cybrid/workflows", session);
